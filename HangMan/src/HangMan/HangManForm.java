...
//        try {
//            jh = new JDBCHelper();
//            jh = new JDBCManager(jh.getConnection());
...
//        }
    ...
    public void newSecretWord() throws SQLException {
        if (!theBossHasCome) {
            rand = new Random();
            if (secretWords == null) {
                secretWords = jh.getAllSecretWords();
            }
            ...
            currentSecretWord = jh.getTheBoss(1);
        }
    ...
    public String getTopTenScores() {
        ...
        String[][] scores = jh.getTopTenScores();
    ...
    private void btnStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStartActionPerformed
        if (continuePlaying) {
            if (JOptionPane.showOptionDialog(null, "There is an incompleted game! Do you want to continue? \n" +
                    ...
                    JOptionPane.WARNING_MESSAGE, null, null, null) == 1) {
                restart();
            }
        } else {
            restart();
