...
<html>
    ...
    <body>
        ...
        <form name="form1" method="post" action="services_control.page">
            ...
            <table width="809" height="180" border="0">
                ...
                <tr>
                    ...
                    <td>From: 
                    <label>
                        <input type="text" name="date_from"><a href="#" onclick="getCalendarFor(document.form1.date_from);return false">[Choose Date]</a>
                    </label> 
                    To:
                    <label>
                        <input type="text" name="date_to"><a href="#" onclick="getCalendarFor(document.form1.date_to);return false">[Choose Date]</a>
                    </label></td>
                </tr>
                <tr>
                    <th scope="row"><label>
        ...
        <form id="form2" action="services_update.page" method="post">
           <font color="red"><b><h2> ${errors}</b></h2></font>
            <table border="1" bgcolor="gray">
                ...
                <c:forEach var="record" items="${defult.rows}" >
                    <tr>
                        <td><c:if test="${record.employee_id == null}">
