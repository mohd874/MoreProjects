...
<table width="800" height="600" border="0" cellspacing="0" bgcolor="#FDD398">
  ...
  <tr>
	...
	<div id="center_center">
	 <font face="Times New Roman, Times, serif"><h1><em><strong> <p>&nbsp;</p>
	       <p>Thank you for registration in Daffodils Palace Hotel</p>
	       <p>You can now reserve rooms that will satisfy your needs </p></strong></em></h1></font>
