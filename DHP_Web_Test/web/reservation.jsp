            ...
            <tr>
                ...
                <td height="500" width="600" colspan="2" rowspan="2"><div id="center"></br>
                    <div id="center_center">
                        <jsp:useBean id="field_values" class="com.hotel.model.reservation_on_error" scope="request"/>
                        <jsp:setProperty name="field_values" property="*"/>
                        <form id="form1" name="form1" method="post" action="reservation.page">
                            <p>:
                                <label></label>
                            </p>
                            <table width="522" height="559" border="0" cellspacing="0">
                                <tr>
                                    <td height="43" colspan="2"><span class="style1">Personal Information </span></td>
                                </tr>
                                <tr>
                                    <td width="175" height="43">Customer Name:</td>
                                    <td width="343"><input type="text" name="name" value=""/></td>
                                </tr>
                                <tr>
                                    <td height="43">Date of Arrival:
                                    <label></label></td>
                                    <td><input type="text" name="date_arrival" readonly="true" value="${field_values.ard}"/>
                                    <a href="#" onclick="getCalendarFor(document.form1.date_arrival);return false">[Choose Date]</a><font color="red">*${field_values.ht[ard]}</font></td>
                                </tr>
                                <tr>
                                    <td height="43">Date of Depart:</td>
                                    <td><input type="text" name="date_depart" readonly="true" value="${field_values.dpd}"/>
                                    <a href="#" onclick="getCalendarFor(document.form1.date_depart);return false">[Choose Date]</a><font color="red">*${field_values.ht["dpd"]}</font></td>
                                </tr>
                                <tr>
                                    <td height="43">Flight Number: </td>
                                    <td><label>
                                        <input name="flight" type="text" id="flight" value="${field_values.flight}"/><font color="red">*</font>
                                    </label></td>
                                </tr>
                                <tr>
                                    <td height="43">Credit Card No:
                                    <label> </label></td>
                                    <td><input name="credit_card_no" type="text" maxlength="12" value="${field_values.ccn}"/>
                                ...
                                <tr>
                                    ...
                                    <td>Yes
                                    <label>
                                        <input name="confirmation" type="radio" value="y" checked="checked" />
                                    </label>
                                    No
                                    <label>
                                        <input name="confirmation" type="radio" value="n" />
                                    </label></td>
                                </tr>
                                <tr>
                                    <td height="43">Note:</td>
                                    <td><label>
                                        <textarea name="note" id="note">Any notes or additional demands can be puted here</textarea>
                                    </label></td>
                                </tr>
                                <tr>
