...
public class DB_Control {
    ...
    public static String Open_DB_Connection(){
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/dph_db_test", "root", "");
    ...
    public static ResultSet execute_sql_query(String query){
    ...
    public static int update_database(String query){
