...
public class DB_Checker {
    ...
    public void check_finished_reservations(){
        ...
        String sql_query = "select * from customer_reservation where depart_date > '"+shortDate+"'";
    ...
    public void check_finished_events(){
        ...
        //preparing sql_query
        String sql_query = "select * from event_schedule where date_to > '"+ shortDate +"'";
    ...
    public void ckeck_confirmed_rooms(){
        //open database connection
        DB_Control.Open_DB_Connection();
